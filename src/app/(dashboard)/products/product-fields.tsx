...
export function ProductFields({ initial = {}, disabled = false, legacyName = "" }: { initial?: Record<string, string | null | undefined>; disabled?: boolean; legacyName?: string }) {
  ...
  return <>
    ...
    <p className="text-sm text-slate-500 sm:col-span-2">Display preview: <strong>{preview || legacyName || "尚未產生名稱"}</strong></p>
  </>;
}
